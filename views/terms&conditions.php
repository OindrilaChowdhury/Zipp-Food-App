...
<body>
<br><hr>
<a href="../views/welcome_page.php"><img src="/project/storage/images/photo.png" width="200" height="100" title="Zipp Food" alt="Logo of a ZippFood" /></a>
<hr>
<h1><span style="color:Blue">Terms and Conditions</span></h1>


Terms & Conditions
Read this section for five minutes and you’ll feel like a lawyer
...
1.1 We are ZipFood, a brand of www.zipFood.com, unless otherwise stated.
...
2.3 "you", "your" and "yours" are references to you the person accessing this Website and ordering any Goods or Services from the Website or from any other channel provided by Hungrynaki

2.4 "we", "us", "our", and "ZipFood" are references to the Company
...
2.8 "Website" is a reference to our Website https://www.ZipFood.com or our mobile applications on which we offer our Goods or Services.

Section 3: Ordering

3.1 Any contract for the supply of Food Delivery from this Website is either between you and the Participating Restaurant or you and Hungrynaki, depending on how Participating Restaurant decided to serve you; for the supply of Goods or Services from this Website any contact is between you and Hungrynaki. You agree to take particular care when providing us with your details and warrant that these details are accurate and complete at the time of ordering. You also warrant that the credit or debit card details that you provide are of your own credit or debit card and that you have sufficient funds to make the payment.
...
3.6 Any order that you place with us is subject to product availability, delivery capacity and acceptance by us and the Participating Restaurant. When you place your order online, we will send you an email and SMS to confirm that we have received your order. This email and SMS confirmation will be produced automatically so that you have confirmation of your order details. You must inform us immediately if any details are incorrect. Inform us over phone within 5 minutes of receiving the mail or the SMS. The fact that you receive an automatic confirmation does not necessarily mean that either we or the Participating Restaurant will be able to fill your order. Once we have sent the confirmation email we will check availability and delivery capacity. We may choose to call you at times when you are ordering in bulk.

3.7 If the ordered food and delivery capacity is available, the ZipFood will accept the order and confirm it to the relevant restaurant.

3.8 The approximate delivery time may vary in case of unavoidable circumstances.

3.9 If any/all ordered food item(s) are not available or if there is no delivery capacity, our customer service will call you to discuss alternatives.

Section 4: Prices and Payment

4.1 Any contract for the supply of food from this Website is between you and the participating restaurant; for the supply of food, any contact is between you and HungryNaki. You agree to take particular care when providing us with your details and warrant that these details are accurate and complete at the time of ordering. You also warrant that the credit or debit card details that you provide are for your own credit or debit card and that you have sufficient funds to make the payment.
...
4.3 All prices listed on the Website for food menu by the participating restaurant or a delivery partner listed on the Website reflect the price the Participating Restaurant or the third party provider charges at the time of listing. In case the price listed is not current and the restaurant informs us immediately after placing the order, we will put our best effort to contact you to inform you about the price difference and you can choose to opt-out of the order at that time.

4.4 All prices for delivery by ZipFood or a third party provider assigned by Hungrynaki listed on the Website are correct at the time of publication; however, we reserve the right to alter these in the future.

4.5 The total price for Food Delivery, Goods or Services ordered, including delivery charges and other charges, will be displayed on the Website when you place your order. Full payment must be made for all Goods despatched and Services provided. Payment has to be made by online payment, e.g. credit or debit card, or bKash or Hungry card.
...
5.2 If delivery is done by the Participating Restaurant or delivery partners, it is the Participating Restaurants sole responsibility to provide Food Delivery in a timely manner.

5.3 In the case delivery is done by Hungrynaki or a third party delivery partner assigned by Hungrynaki, we will take full responsibility to deliver in a timely manner. However, if the process is hampered due to unavoidable issues, i.e- traffic jam then it is not our responsibility to take.
...
5.5 In case of a late delivery, the delivery charge will neither be voided nor refunded by Hungrynaki.
...
6.4 In the unlikely event that the Participating Restaurant or Hungrynaki delivers a wrong item, you have the right to reject the delivery of the wrong item and you shall be fully refunded for the missing item. If the Participating Restaurant or Hungrynaki can only do a partial delivery (a few items might be not available), its staff should inform you or propose a replacement for missing items. You have the right to refuse a partial order before delivery and get a refund.
...
9.1 We take complaints very seriously and aim to respond to your complaints within 2 business day. All complaints should be addressed to support@hungrynaki.com.

Section 10: Limitation of Liability

10.1 Great care has been taken to ensure that the information available on this Website is correct and error free. We apologize for any errors or omissions that may have occurred. We cannot warrant that use of the Website will be absolutely error free or fit for purpose, timely, the defects will be corrected, or that the site or the server that makes it available are free of viruses or bugs or represents the full functionality, accuracy, reliability of the Website and we do not make any warranty whatsoever, whether express or implied, relating to fitness for purpose, or accuracy.
...
10.5 We shall not be held liable for any failure or delay in performing Services or delivering Goods where such failure arises as a result of any act or omission, which is outside our reasonable control such as an act of God or those of third parties.
...
11.1 All prices are in Bangladeshi Taka. VAT is included where indicated.
